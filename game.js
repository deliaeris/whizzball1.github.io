$(window).load(function(){
	...
	if (player.temp_protons_in_atom == 4 && player.temp_neutrons_in_atom == 7 && player.temp_electrons_in_atom == 4) {
            ...
            setTimeout(function () {
		alert("Boron-11, which Beryllium-11 decays into after 13.81 seconds, has not been defined yet, and so this atom will disappear. Thank you for your time.");
		...
		player.protonClicks += 4;
		player.neutronClicks += 7;
		player.electronClicks += 4;
            }, 13810);
	}
	if (player.temp_protons_in_atom == 4 && player.temp_neutrons_in_atom == 8 && player.temp_electrons_in_atom == 4) {
            ...
            setTimeout(function () {
		alert("Boron-12, which Beryllium-12 decays into after 21 milliseconds, has not been defined yet, and so this atom will disappear. Thank you for your time.");
